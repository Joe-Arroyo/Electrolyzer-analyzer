...
# Maps combo index to (label, file_filter, loader_key)
INSTRUMENTS = [
...
class ChronopotentiometryTab(QWidget):
    ...
    def _parse_file(self, instrument_idx: int, file_path: str):
        """Dispatch to the correct parser based on instrument selection"""
        if instrument_idx == 0:
    ...
    def get_filtered_data(self):
        """Return data dict with time filter applied if enabled"""
